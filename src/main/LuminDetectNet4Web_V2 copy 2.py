...
if st.session_state['processing_results']:
    ...
    # --- Simplified logic for the "All Classified" zip ---
    st.download_button(
        label="Download All Classified Images (ZIP)",
        data=create_classified_images_zip(),
    ...
    # --- Simplified logic for the "Waves Only" zip ---
    st.download_button(
        label="Download ONLY the Images with Waves Detected (ZIP)",
        data=create_images_with_waves_zip(),
