...
if st.button("Reset Uploads"):
    ...
    st.session_state['classified_zip_buffer'] = None # Clear zip buffers on reset
    st.session_state['waves_zip_buffer'] = None
...
if st.session_state['processing_results']:
    ...
    if st.button("Generate a zip file containing ALL classified images"):
    ...
    if st.session_state.get('classified_zip_buffer'):
        st.download_button(
            label="Download ALL classified images",
    ...
    if st.button("Generate a zip file containing ONLY the images with waves detected"):
        with st.spinner("Creating zip archive... This may take a moment for large datasets."):
            st.session_state['waves_zip_buffer'] = create_images_with_waves_zip()
    
    if st.session_state.get('waves_zip_buffer'):
        st.download_button(
            label="Download ONLY the Images with Waves",
